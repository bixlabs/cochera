 ...
 * @ngdoc object
 * @name lbServices.Url
 * @header lbServices.Url
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Url` model.
 *
 * ## Example
 *
 * See
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/urls/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Url#create
             * @methodOf lbServices.Url
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Url` object.)
             * </em>
             */
            "create": {
              url: urlBase + "/urls",
            ...
            /**
             * @ngdoc method
             * @name lbServices.Url#createMany
             * @methodOf lbServices.Url
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/urls/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Url#findById
             * @methodOf lbServices.Url
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/urls/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Url#updateAll
             * @methodOf lbServices.Url
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/urls/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Url#deleteById
             * @methodOf lbServices.Url
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/urls/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Url#prototype$updateAttributes
             * @methodOf lbServices.Url
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Url#createChangeStream
             * @methodOf lbServices.Url
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/urls/change-stream",
              method: "POST",
            },
          }
        );
            ...
            /**
             * @ngdoc method
             * @name lbServices.Url#updateOrCreate
             * @methodOf lbServices.Url
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Url#destroyById
             * @methodOf lbServices.Url
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Url#removeById
             * @methodOf lbServices.Url
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Url#modelName
        * @propertyOf lbServices.Url
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Url`.
        */
        ...
        urlBase + "/profiles/:id",
          { 'id': '@id' },
          {
            ...
            "findOrCreateSubscription": {
              url: urlBase + "/profiles/findOrCreate",
              method: "PUT",
            },
          }
        );
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/subcriptions/:id",
          { 'id': '@id' },
          {
             ...
             */
            "exists": {
              url: urlBase + "/subcriptions/:id/exists",
              method: "GET",
            },
             ...
             */
            "findOne": {
              url: urlBase + "/subcriptions/findOne",
              method: "GET",
            },
             ...
             */
            "updateAll": {
              url: urlBase + "/subcriptions/update",
              method: "POST",
            },
             ...
             */
            "count": {
              url: urlBase + "/subcriptions/count",
              method: "GET",
            },
             ...
             */
            "createChangeStream": {
              url: urlBase + "/subcriptions/change-stream",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Subscription#createSubscription
             * @methodOf lbServices.Subscription
             *
             * @description
             *
             ...
             */
            "createSubscription": {
              url: urlBase + "/subcriptions/chargebee/create",
              method: "POST",
            },
          }
        );
...
/**
 * @ngdoc object
 * @name lbServices.Ghost
 * @header lbServices.Ghost
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Ghost` model.
 *
 * ## Example
 *
 * See
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/ghosts/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Ghost#find
             * @methodOf lbServices.Ghost
             *
             * @description
             *
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Ghost` object.)
             * </em>
             */
            "find": {
              isArray: true,
              url: urlBase + "/ghosts/find",
              method: "GET",
            },
          }
        );
        ...
        /**
        * @ngdoc property
        * @name lbServices.Ghost#modelName
        * @propertyOf lbServices.Ghost
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Ghost`.
        */
